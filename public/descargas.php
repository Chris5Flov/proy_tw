...
$archivos_disponibles = $manager->obtenerArchivos($filtro_activo, $search);
?>
    ...
    <div class="downloads-layout"> 
        ...
        <aside class="sidebar-filtro">
            ...
            <form method="GET" class="search-box">
                ...
                <input type="hidden" name="tipo" value="<?= htmlspecialchars($filtro_activo) ?>">
            </form>
            ...
            <div class="filter-section">
                ...
                <div class="file-type-list">
                    ...
                    <a href="?tipo=Todos" class="<?= ($filtro_activo === 'Todos') ? 'active-filter' : '' ?>">Todos</a>
                </div>
            </div>
        </aside>
        ...
        <section class="file-gallery">
            ...
            <?php if (empty($archivos_disponibles)): ?>
                <p>No se encontraron archivos que coincidan.</p>
            <?php else: ?>
                ...
                <div class="file-item">
                    ...
                    <div class="file-name">
                        <?= htmlspecialchars($archivo['nombre']) ?>.<?= htmlspecialchars($archivo['tipo']) ?>
                    </div>
